  ...
  return (
    ...
    >
      <div className="pb-5">
        ...
        <div className="flex items-center gap-2 mt-5 bg-[#282142] rounded-full px-3 py-2">
      ...
      <div className="flex flex-col">
        ...
        key={index} className={`flex items-center gap-3 relative cursor-pointer hover:bg-[#282142] rounded-lg p-2 ${selectedUser?._id === user._id && "bg-[#282142]/50" }`}> 
